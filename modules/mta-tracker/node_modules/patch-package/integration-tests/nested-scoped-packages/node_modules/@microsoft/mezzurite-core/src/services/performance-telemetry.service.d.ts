 ...
 */
export declare class PerformanceTelemetryService {
    /**
     * Starts capture cycle period
     */
    static startCaptureCycle(): void;
    /**
     ...
     */
    static captureTimings(isRedirect?: boolean): void;
    /**
     ...
     * @param timings
     */
    static log(timings: any): void;
    /**
     * Checks whether window.performance is undefined
     */
    static compatibilityCheck(): boolean;
}
