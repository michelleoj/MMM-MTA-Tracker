(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@microsoft/mezzurite-core'), require('rxjs/operators'), require('@angular/core'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('@microsoft/mezzurite-angular', ['exports', '@microsoft/mezzurite-core', 'rxjs/operators', '@angular/core', '@angular/router'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.mezzuriteAngular = {}),global['mezzurite-core'],global.rxjs.operators,global.ng.core,global.ng.router));
}(this, (function (exports,mezzuriteCore,operators,core,router) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var RoutingService = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            /** @type {?} */
            var onNavStart$ = (/** @type {?} */ (this)).router.events.pipe(operators.filter(function (event) { return event instanceof router.NavigationStart; }));
        ...
        function (e) {
            ...
            if ((/** @type {?} */ (window)).mezzurite.captureCycleStarted) {
                ...
                mezzuriteCore.PerformanceTelemetryService.captureTimings(true);
                window.performance.mark(mezzuriteCore.MezzuriteConstants.vltMarkStart);
                // starts a new capture cycle
                mezzuriteCore.PerformanceTelemetryService.startCaptureCycle();
            }
            else {
                ...
                if (!(/** @type {?} */ (window)).mezzurite.firstViewLoaded) {
                    window.performance.mark(mezzuriteCore.MezzuriteConstants.altMarkEnd);
                    window.performance.mark(mezzuriteCore.MezzuriteConstants.vltMarkStart);
                    /** @type {?} */
                    var fullName = MezzuriteAngularUtils.getName(mezzuriteCore.MezzuriteConstants.altName, MezzuriteAngularUtils.makeId());
                    mezzuriteCore.PerformanceTimingService.measure(fullName, 0, mezzuriteCore.MezzuriteConstants.altMarkEnd);
                }
                else {
                    window.performance.mark(mezzuriteCore.MezzuriteConstants.vltMarkStart);
                }
    ...
    var MezzuriteDirective = /** @class */ (function () {
        function MezzuriteDirective(ref) {
            ...
            this.id = mezzuriteCore.MezzuriteUtils.makeId();
            performance.mark(this.id + mezzuriteCore.MezzuriteConstants.componentMarkStart);
         ...
         */
        function () {
            this.fullName = mezzuriteCore.MezzuriteUtils.getName(this.title, this.id);
            ...
            var intObserver = new IntersectionObserver(function (entries, observer) {
                performance.mark(that.id + mezzuriteCore.MezzuriteConstants.componentMarkEnd);
                /** @type {?} */
                var entry = entries[0];
        ...
        MezzuriteDirective.propDecorators = {
            title: [{ type: core.Input, args: ['component-title',] }]
        };
    ...
    exports.AngularPerfModule = AngularPerfModule;
    exports.ɵa = MezzuriteDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=mezzurite-angular.umd.js.map
